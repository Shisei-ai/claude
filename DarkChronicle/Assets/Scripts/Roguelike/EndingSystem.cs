...
namespace DarkChronicle.Roguelike.Relics
{
    ...
    public static class EndingSystem
    {
        ...
        /// <summary>
        /// Short character-specific epilogue shown after the main ending text.
        /// <paramref name="characterName"/> must match CharacterData.name (asset file name).
        /// Returns empty string for unknown characters so the caller can skip it.
        /// </summary>
        public static string GetCharacterEpilogue(string characterName, EndingType ending, bool won)
        {
            return characterName switch
            {
                "Ash" => won
                    ? "魔王の玉座が砕け落ちる音の中、Ashはただ静かに立っていた。\n" +
                      "国の秘密を知りすぎた男が行き着いた先がここだったとは——皮肉だとは思わない。\n" +
                      "影の中を生きた者が、最後に光の前に立った。それでいい。"
                    : "今日は届かなかった。だが、Ashは今日も生き延びた。\n" +
                      "逃げることを知っている男に、敗北は付きものだ——重要なのは、次があるということだ。\n" +
                      "また始まりの場所に戻ってきた。次は、もっと上手くやる。",

                "Zeno" => won
                    ? "アカリ——。\n" +
                      "この勝利をどれだけ彼女に伝えたかったか。どんな代償を払っても取り戻すと誓ったあの日から、Zenoはずっと走り続けてきた。\n" +
                      "まだ終わりではない。でも、今日だけは少し休んでいい気がした。"
                    : "届かなかった。アカリへの誓いを、また果たせなかった。\n" +
                      "Zenoの目には悔しさよりも、静かな決意が宿っていた。\n" +
                      "死は許されない——まだ取り戻すべき者がいる限り。",

                "Bernhard" => won
                    ? "灰になった王国の記憶が、少しだけ安らいだ気がした。\n" +
                      "死んでいった仲間たちに、今日の結果を報告できるだろうか。Bernhardにはまだわからない。\n" +
                      "だが剣を置く理由が、今日も見つからなかった。贖罪はまだ続く。"
                    : "また敗れた。しかしBernhardは戦場から戻った——今日も、生き残った。\n" +
                      "それが罰なのか試練なのか、彼にはわからない。\n" +
                      "倒れた仲間たちの分まで立ち続けること。それだけが今の彼にできることだ。",

                "Lavinia" => won
                    ? "契約の代償が体を蝕んでいるのを感じながら、Laviniaはそれでも微笑んだ。\n" +
                      "時間を対価に力を得た——その選択に後悔はない。今日もその力は世界に意味をもたらした。\n" +
                      "残された時間を、どう使うか。それだけを考えながら、彼女は歩き続ける。"
                    : "力が続かなかった。Laviniaは冷静に自分の限界を受け止めた。\n" +
                ...
                "Lilia" => won
                    ? "神様、聞こえていますか——祈りが届いた気がします。\n" +
                      ...
                      "Liliaはまた祈る。次の旅でも、力が必要な誰かのために。"
                    : "今日は守れなかった。Liliaは涙をこらえながら、それでも前を向いた。\n" +
