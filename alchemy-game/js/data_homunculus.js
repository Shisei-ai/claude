...
//    (100体続けて【秀】以上が出なければ、次は必ず【秀】 = 天井。確率も天井もゲーム内では伏せている)
...
const HOMU_MEDIA = [
  { name: '霊媒なし',   hint: '何が生まれるかは瓶の気まぐれ。多くは凡庸な小人だ。', item: null,           n: 0, weights: { n: 88, r: 10, sr: 2,  ur: 0 },  time: 1,   book: null },
  { name: '命の揺籃液', hint: '良質な小人が生まれやすくなる。', item: 'cradle_fluid', n: 2, weights: { n: 55, r: 35, sr: 9,  ur: 1 },  time: 1.3, book: 'h_book2' },
  { name: '月霊の結晶', hint: '凡庸な小人はめったに生まれない。秀でた小人も珍しくない。', item: 'moon_crystal', n: 2, weights: { n: 15, r: 50, sr: 30, ur: 5 },  time: 1.6, book: 'h_book4' },
  { name: '魂の萌芽',   hint: '凡庸な小人は生まれない。秀でた小人が多く、ときに輝く者が現れる。', item: 'soul_seed',    n: 1, weights: { n: 0,  r: 25, sr: 55, ur: 20 }, time: 2,   book: 'h_book4' },
];
const HOMU_PITY = 100; // 【秀】以上が出ないまま、この数だけ生まれたら次は必ず【秀】(【極】は保証しない)
const HOMU_PITY_OMEN = 0.8; // 天井までの8割を越えると、瓶に「兆し」が現れる(残り数は見せない)
...
const HOMU_BOOKS = [
  ...
  { id: 'h_book4', kind: 'alchemy', lv: 15, sp: 2, name: '秀でし小人', recipes: ['r_mooncrystal', 'r_soulseed'],
    text: ['霧の鉱山の月長石、雪の精の鱗粉、冥界の魂の残滓。', 'それらから作る霊媒──「月霊の結晶」と「魂の萌芽」は、秀でた小人を呼び寄せる。',
      '瓶は幾度も空振りする。だが空振りが続くほど、瓶の底には何かが溜まっていく。やがて瓶は熱を帯び、脈打ちはじめる──その兆しを見逃すな。'] },
