...
function newState() {
  return {
    ...
    slots: [null, null, null, null, null, null], // 数字キー1〜6の魔法
    flags: { prologue: false, bossDefeated: false, ended: false },
    stats: { made: {}, visited: {}, kills: 0 },
    log: [],
  };
}
...
// ---- レベル --------------------------------------------------
// 次のレベルまでに必要な経験値
const xpNeed = lv => Math.round(12 * Math.pow(lv, 1.5));
...
function playerStats() {
  return {
    ...
    lossOnDeath: 0.5 - 0.25 * skill('exp_keep'),
  };
}
