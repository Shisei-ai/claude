...
- **命名**: `キャラID_表情.png`（例：`ai_neutral.png` / `op_alert.png`）。自由でも可。
...
```js
op: {
  name: 'オペレーター', color: '#ffd24a', side: 'right', icon: '🎧',
  img: {
    neutral: 'portraits/op_neutral.png',
    alert:   'portraits/op_alert.png',
    smile:   'portraits/op_smile.png',
  },
},
```
