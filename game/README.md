...
2. **中間素材を製錬** … 製錬炉などが 基本素材＋水/燃料 から **合金・回路・動力核・秘銀鋼** を生産（電力で稼働）。
...
- **鉱区（Ⅰ〜Ⅵ）** … ストーリー進行で順次解放。各鉱区に投入した**採取モジュールの数**で素材の産出量が変わる。
  モジュールは「モジュール工房」で生産し、研究／ストーリーで**保有上限**が拡張される（鉱区Ⅵはダイヤに加えミスリルを副産）。
- **ユーティリティ** … 電気（フロー）・水・燃料。中間素材設備の稼働に必要。
- **中間素材** … 合金（鉄＋銅＋水）・回路（銀＋金＋水）・動力核（プラチナ＋ダイヤ＋燃料）・秘銀鋼（ミスリル＋合金＋燃料）。
