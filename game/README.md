...
- **ドット絵キャラクター** … 5兵科それぞれを個性的にデザイン（歩兵・突撃兵・重装兵・射撃兵・飛行兵）。
  歩行で脚が振れ、空中機は推進炎をなびかせる。敵「群体」も小型蟲〜飛翔体〜巨核ボスまで描き分け。
- **グレード昇格で外見が変化** … ボディ／ウェポンのグレードが上がると、肩当て・頭頂クレスト等の
  **追加装甲**、**武器の大型化**（武装種で色も変化）、**階級章（シェブロン）** と発光オーラが付与される。
